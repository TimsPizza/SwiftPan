...
#[test]
fn missing_region_and_explicit_auto_share_the_same_operator_fingerprint() {
...
#[test]
fn every_r2_configuration_field_participates_in_operator_fingerprint() {
    let original = config();
    ...
    for variant in variants {
        assert_ne!(
            ...
            baseline,
            "configuration change reused the cached operator fingerprint"
        );
    }
}
