...
export const Sidebar = () => {
  ...
  const navItems = [
    ...
    { href: "/usage", icon: BarChartIcon, label: "Usage & Costs" },
    { href: "/settings", icon: GearIcon, label: "Settings" },
  ];

  return (
    <div className="bg-sidebar text-sidebar-foreground border-sidebar-border flex h-full w-64 flex-col border-r p-4">
